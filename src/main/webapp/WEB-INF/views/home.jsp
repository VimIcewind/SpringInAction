            ...
            <li>
                <span class="spittleListImage">
                    <img src="http://s3.amazonaws.com/spitterImages/${spittle.spitter.id}.jpg"
                         width="48" border="0" align="middle" onError="this.src='<s:url value="/resources/images"/>/spitter_avatar.png';"/>
                </span>
                <span class="spitterListText">
                    ...
                    <small>
                        <fmt:formatDate value="${spittle.time}" pattern="hh:mma MMM d, yyyy"/>
                    </small>
                </span>
            </li>
        </c:forEach>
